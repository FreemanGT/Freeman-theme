...
- Fix RestockNotify privacy exporter and eraser registration when the module is disabled so retained subscriber PII remains covered by WordPress privacy tools.
