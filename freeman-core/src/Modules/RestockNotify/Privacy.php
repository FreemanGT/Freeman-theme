 ...
 * hard-delete rows. It blanks `customer_name`, replaces `customer_email` with
 * a non-PII row marker, and sets `status='unsubscribed'`. The row stays as
 * an audit trail and the stock monitor can no longer match the original email
 * on future restocks.
 *
