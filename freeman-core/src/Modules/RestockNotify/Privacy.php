 ...
 * hard-delete rows. It clears `customer_name`, replaces `customer_email` with
 * a per-row non-PII tombstone, and sets `status='unsubscribed'`. The row stays
 * as an audit trail and the stock monitor can no longer match the email on
 * future restocks.
 *
