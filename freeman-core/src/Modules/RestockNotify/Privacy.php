 ...
 * with a non-personal per-row marker (the legacy schema declares it NOT
 * NULL), and sets `status='unsubscribed'`. The row stays as an audit trail
 * and the stock monitor can no longer match the email on future restocks.
 *
